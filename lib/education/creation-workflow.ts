...
import type { CreationControllerState, EducationProgramId, ResearchBrief } from "./types";
...
const educationProgramIdSchema = z.enum([
...
const creationControllerOutputSchema = z.object({
  action: z.enum(["ask", "clarify", "confirm", "complete"]),
...
async function buildWorkflowDraft(
  ...
  const programId = output.programId as EducationProgramId;
