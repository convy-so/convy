import { renderStrictScopePolicyInstructions } from "@/lib/ai/scope-policy";
...
export function renderLearningOutcomes(outcomes: LearningOutcomeDefinition[]) {
    ...
    ? input.uniqueReports
        ...
        .map((report, index) => {
          ...
          return [
            ...
            `Student summary: ${normalizeLine(String(payload.studentSummary ?? "")) || "none"}`,
            `Pedagogical summary: ${normalizeLine(String(payload.pedagogicalSummary ?? "")) || "none"}`,
