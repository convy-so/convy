...
CREATE TYPE "public"."user_role" AS ENUM('user', 'expert', 'admin');--> statement-breakpoint
...
CREATE TABLE "expert_runtime_models" (
	...
	"version" integer NOT NULL,
	"status" text DEFAULT 'draft' NOT NULL,
	"runtime_model" jsonb NOT NULL,
	"conflict_ids" jsonb DEFAULT '[]'::jsonb,
	"published_at" timestamp with time zone,
	"published_by_user_id" text,
...
CREATE TABLE "learning_sessions" (
	...
	"state" jsonb DEFAULT '{"topicTitle":"","runtimeModelId":null,"runtimeModelVersion":1,"studentModelId":null,"studentModelSnapshotId":null,"frameworkState":{"currentStageId":null,"completedStageIds":[],"stageAttemptCounts":{},"stageStartedAt":{},"stageCompletedAt":{},"lastTransitionAt":null,"lastTransitionReason":""},"contentScopeSnapshot":null,"activeConceptKey":null,"activeConceptTitle":null,"knowledgeFocus":[],"misconceptionsObserved":[],"recentEvidence":[],"tutorNotes":[],"turnCount":0,"turnsSinceStudentModelRefresh":0,"lastStudentModelRefreshAt":null,"reportReady":false,"completed":false}'::jsonb,
	"opening_plan" jsonb,
	"summary" text,
	"completed_at" timestamp with time zone,
...
CREATE TABLE "learning_topics" (
	...
	"subject_label" text DEFAULT 'General' NOT NULL,
	"status" text DEFAULT 'draft' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "student_model_analyses" (
	"id" text PRIMARY KEY NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	...
	"error_message" text,
	CONSTRAINT "student_model_analyses_source_unique" UNIQUE("source_type","source_id")
);
--> statement-breakpoint
CREATE TABLE "student_model_snapshots" (
	...
	"version" integer NOT NULL,
	"snapshot" jsonb NOT NULL,
	"source_type" text DEFAULT 'session' NOT NULL,
	"source_id" text,
	CONSTRAINT "student_model_snapshots_model_version_unique" UNIQUE("student_model_id","version")
);
--> statement-breakpoint
CREATE TABLE "student_models" (
	...
	"anomaly_status" text DEFAULT 'clear' NOT NULL,
	"last_reviewed_at" timestamp with time zone,
	CONSTRAINT "student_models_classroom_student_unique" UNIQUE("classroom_student_id")
);
--> statement-breakpoint
...
ALTER TABLE "expert_frameworks" ADD CONSTRAINT "expert_frameworks_classroom_id_classrooms_id_fk" FOREIGN KEY ("classroom_id") REFERENCES "public"."classrooms"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "expert_frameworks" ADD CONSTRAINT "expert_frameworks_topic_id_learning_topics_id_fk" FOREIGN KEY ("topic_id") REFERENCES "public"."learning_topics"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "expert_runtime_models" ADD CONSTRAINT "expert_runtime_models_framework_version_id_expert_framework_versions_id_fk" FOREIGN KEY ("framework_version_id") REFERENCES "public"."expert_framework_versions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "expert_runtime_models" ADD CONSTRAINT "expert_runtime_models_published_by_user_id_users_id_fk" FOREIGN KEY ("published_by_user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "learning_material_embeddings" ADD CONSTRAINT "learning_material_embeddings_topic_id_learning_topics_id_fk" FOREIGN KEY ("topic_id") REFERENCES "public"."learning_topics"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "learning_material_embeddings" ADD CONSTRAINT "learning_material_embeddings_classroom_id_classrooms_id_fk" FOREIGN KEY ("classroom_id") REFERENCES "public"."classrooms"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "learning_material_embeddings" ADD CONSTRAINT "learning_material_embeddings_material_id_topic_materials_id_fk" FOREIGN KEY ("material_id") REFERENCES "public"."topic_materials"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "student_model_analyses" ADD CONSTRAINT "student_model_analyses_student_model_id_student_models_id_fk" FOREIGN KEY ("student_model_id") REFERENCES "public"."student_models"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "student_model_analyses" ADD CONSTRAINT "student_model_analyses_topic_id_learning_topics_id_fk" FOREIGN KEY ("topic_id") REFERENCES "public"."learning_topics"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "student_model_analyses" ADD CONSTRAINT "student_model_analyses_session_id_learning_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."learning_sessions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "student_model_snapshots" ADD CONSTRAINT "student_model_snapshots_student_model_id_student_models_id_fk" FOREIGN KEY ("student_model_id") REFERENCES "public"."student_models"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "student_models" ADD CONSTRAINT "student_models_student_user_id_users_id_fk" FOREIGN KEY ("student_user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "student_models" ADD CONSTRAINT "student_models_classroom_student_id_classroom_students_id_fk" FOREIGN KEY ("classroom_student_id") REFERENCES "public"."classroom_students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "learning_material_embeddings_classroom_id_idx" ON "learning_material_embeddings" USING btree ("classroom_id");--> statement-breakpoint
CREATE INDEX "learning_material_embeddings_topic_id_idx" ON "learning_material_embeddings" USING btree ("topic_id");--> statement-breakpoint
CREATE INDEX "learning_material_embeddings_material_id_idx" ON "learning_material_embeddings" USING btree ("material_id");--> statement-breakpoint
CREATE INDEX "learning_material_embeddings_subject_key_idx" ON "learning_material_embeddings" USING btree ("subject_key");--> statement-breakpoint
CREATE INDEX "learning_material_embeddings_locale_idx" ON "learning_material_embeddings" USING btree ("content_locale");--> statement-breakpoint
CREATE INDEX "learning_material_embeddings_embedding_idx" ON "learning_material_embeddings" USING hnsw ("embedding" vector_cosine_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "learning_material_embeddings_material_chunk_unique" ON "learning_material_embeddings" USING btree ("material_id","chunk_index");--> statement-breakpoint
...
CREATE INDEX "student_model_analyses_model_idx" ON "student_model_analyses" USING btree ("student_model_id");--> statement-breakpoint
CREATE INDEX "student_model_analyses_topic_idx" ON "student_model_analyses" USING btree ("topic_id");--> statement-breakpoint
CREATE INDEX "student_model_snapshots_model_idx" ON "student_model_snapshots" USING btree ("student_model_id");--> statement-breakpoint
CREATE INDEX "student_models_user_idx" ON "student_models" USING btree ("student_user_id");--> statement-breakpoint
