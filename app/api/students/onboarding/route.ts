...
export async function GET() {
  try {
    ...
    return handleTutoringRouteError(error, "Failed to load onboarding", "/api/students/onboarding");
  }
}
...
export async function POST(request: Request) {
  try {
    ...
    return handleTutoringRouteError(error, "Failed to continue onboarding", "/api/students/onboarding");
  }
}
