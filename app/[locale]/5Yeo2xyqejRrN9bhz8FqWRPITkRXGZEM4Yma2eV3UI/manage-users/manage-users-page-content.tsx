...
import {
  ...
  normalizeExpertDisplayName,
} from "@/features/auth/public-server";
import { ResendExpertInviteButton } from "@/features/admin/ui/resend-expert-invite-button";
import { getDb } from "@/shared/db";
import { expertInvitations, users } from "@/shared/db/schema";
          ...
          <tbody className="divide-y divide-slate-100">
            {allUsers.map((user) => {
              ...
              const hasPendingInvite =
                user.role === "expert" && Boolean(pendingInvite);
              const invitationExpired = pendingInvite
                ? isExpertInvitationExpired(pendingInvite)
                : false;
