    ...
    <section className="py-20 sm:py-24 px-4 sm:px-6 lg:px-12 bg-[#FAFAFA]">
      <div className="bg-[#232323] text-white rounded-[32px] px-6 sm:px-10 lg:px-16 py-16 sm:py-20 mx-auto max-w-[1920px]">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center gap-10">
          ...
          {/* Main message */}
          <div>
            <p className="text-[18px] md:text-[22px] font-[500] text-[#E5E5E5] leading-[28px] md:leading-[32px]">
              Start improving your product today with
              <br className="hidden sm:block" /> real-time data from Convy.
            </p>
          </div>

          {/* Contact on X */}
          <div className="space-y-2">
            <p className="text-sm text-[#B2B2B2]">Contact us on X</p>
            <a
        ...
        <div className="mt-14 border-t border-white/10 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-[#B2B2B2]">
            ...
            <p className="order-2 sm:order-1">
              © {new Date().getFullYear()} convy. All rights reserved.
            </p>
