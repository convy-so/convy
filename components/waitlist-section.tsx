    ...
    <section className="py-12 sm:py-16 bg-[#FAFAFA] px-4 sm:px-6 lg:px-12">
      <div className="mx-auto max-w-[1920px] flex justify-center">
        <div className="max-w-3xl text-center">
          ...
          {/* Copy */}
          <p className="text-[20px] md:text-[22px] font-normal text-[#696969] leading-[30px] md:leading-[32px] tracking-normal mb-8" dangerouslySetInnerHTML={{ __html: t.raw('Description') }} />
