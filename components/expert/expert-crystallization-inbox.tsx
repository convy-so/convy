            ...
            <div className="p-5 border-b border-slate-100 bg-slate-50/50">
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={() => handleApprove(draft.id, draft)}
                    disabled={isProcessing === draft.id}
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea 
                      ...
                      rows={2}
                      value={editForm.heuristic?.trigger}
                      onChange={(e) => setEditForm({ ...editForm, heuristic: { ...editForm.heuristic!, trigger: e.target.value } })}
                    />
                  </div>
                  <div>
                    ...
                    <textarea 
                      className="w-full text-sm text-slate-700 bg-white border border-slate-200 rounded p-2"
                      rows={2}
                      value={editForm.heuristic?.action}
                      onChange={(e) => setEditForm({ ...editForm, heuristic: { ...editForm.heuristic!, action: e.target.value } })}
                    />
                  </div>
                  <div>
                    ...
                    <textarea 
                      className="w-full text-sm text-slate-700 bg-white border border-slate-200 rounded p-2"
                      rows={2}
                      value={editForm.heuristic?.rationale}
                      onChange={(e) => setEditForm({ ...editForm, heuristic: { ...editForm.heuristic!, rationale: e.target.value } })}
                    />
                  </div>
                  <div>
