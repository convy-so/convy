    ...
    <section className="py-12 sm:py-24 bg-[#FAFAFA] px-4 sm:px-6 lg:px-12">
      <div className="mx-auto max-w-[1920px] flex justify-center">
        <div className="max-w-4xl text-center">
          ...
          {/* Description */}
          <p className="text-[20px] md:text-[24px] font-[500] text-[#696969] leading-[30px] md:leading-[33.6px] tracking-normal mb-10 max-w-2xl mx-auto" dangerouslySetInnerHTML={{ __html: t.raw('Description') }} />
