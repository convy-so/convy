...
export function AddMediaModal({ isOpen, onClose, surveyId, onUploaded }: AddMediaModalProps) {
  ...
  const handleUpload = async () => {
    ...
    if (context.length < 10) {
        toast.error("Context must be at least 10 characters");
        return;
    }
        ...
        <div className="space-y-4">
            ...
            <div>
                ...
                <input
                    ...
                    placeholder="e.g. A photo of our new logo"
                ...
                />
                 <p className="text-xs text-gray-400 mt-1">What is this media showing?</p>
            </div>

            <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Context for Use</label>
                <textarea
                    value={context}
                    onChange={(e) => setContext(e.target.value)}
                    placeholder="e.g. Show this when asking about brand perception"
                    rows={2}
                ...
                />
                <p className="text-xs text-gray-400 mt-1">When should the AI show this to the user?</p>
            </div>
