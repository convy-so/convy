...
import { fetchSurveys, type SurveyListItem } from "@/features/surveys/client/api/surveys-api";
...
export function SurveysPageClient({
  ...
  const confirmDeleteSurvey = async () => {
    ...
    try {
      ...
      if (result.success) {
        void queryClient.invalidateQueries({ queryKey: queryKeys.surveys.all(null) });
                              ...
                              {survey.shareableLink &&
                                ...
                                <button
                                  onClick={() => {
                                    ...
                                    void handleCopyLink(shareableLink);
                                    setShowMenuFor(null);
                                  }}
                                  className="w-full flex items-center gap-2.5 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50"
                                >
