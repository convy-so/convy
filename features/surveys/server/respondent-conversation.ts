...
import { getTimeBasedGreeting } from "@/features/surveys/server/respondent-greetings";
import type { ChatMessage } from "@/shared/chat/chat-types";
import type { ResearchBrief } from "@/features/surveys/server/education/types";
import type { SurveyLanguage } from "@/shared/surveys/constants";
...
export type RespondentLanguage = SurveyLanguage;

export interface CanonicalRespondentTurn {
