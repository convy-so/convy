...
export const createSurveySchema = z.object({
  deliveryMode: z
    .enum(SURVEY_DELIVERY_MODE_VALUES)
...
export const updateSurveySchema = z.object({
  ...
  participantLimit: z
    ...
    .max(
      SURVEY_LIMITS.MAX_PARTICIPANT_LIMIT,
      `Maximum participant limit is ${SURVEY_LIMITS.MAX_PARTICIPANT_LIMIT}`,
    )
    .optional(),
