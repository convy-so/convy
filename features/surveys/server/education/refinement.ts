...
import { buildRefinementAssistantPrompt } from "@/features/surveys/server/education/prompts/refinement-assistant";
import {
...
function applyBriefSetFields(
  ...
  if (isSurveyTone(setFields.tone)) {
