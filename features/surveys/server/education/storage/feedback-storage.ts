...
export async function createSampleFeedbackEntry(params: {
  ...
  return requireValue(
    created,
    `Failed to create sample feedback entry for survey ${params.surveyId}`,
  );
}
...
export async function createSampleFeedbackPatch(params: {
  ...
  return requireValue(
    created,
    `Failed to create sample feedback patch for survey ${params.surveyId}`,
  );
}
...
export async function replaceConductingProfile(params: {
  ...
  return requireValue(
    created,
    `Failed to replace conducting profile for survey ${params.surveyId}`,
  );
}
