...
const lessonMaterialUploadAttemptSchema = z.object({
  id: z.string(),
...
export type LessonMaterialUploadAttempt = z.infer<
  typeof lessonMaterialUploadAttemptSchema
>;
...
export const studentMeSchema = z.discriminatedUnion("role", [
  z.object({
    role: z.literal("student"),
    student: z.array(studentMembershipSchema),
...
export type StudentMeData = z.infer<typeof studentMeSchema>;
...
const tutoringSessionSchema = z.object({
  ...
  sessionState: studentSessionStateSchema,
  messages: z.array(onboardingMessageSchema),
});
...
export type LessonOverviewResponse = z.infer<typeof lessonOverviewSchema>;
...
const lessonInterventionSchema = z.object({
  id: z.string(),
  classroomId: z.string(),
  classroomStudentId: z.string(),
  lessonId: z.string().nullable(),
...
export const classroomLessonsResponseSchema = z.object({
  success: z.literal(true),
  data: z.array(lessonSchema),
});

export const lessonMaterialsResponseSchema = z.object({
  success: z.literal(true),
  data: z.array(lessonMaterialSchema),
});

export const lessonMaterialUploadAttemptsResponseSchema = z.object({
  success: z.literal(true),
  data: z.array(lessonMaterialUploadAttemptSchema),
});

export const retryLessonMaterialUploadAttemptResponseSchema = z.object({
  success: z.literal(true),
  data: z.object({
    attempt: lessonMaterialUploadAttemptSchema,
  }),
});
...
export const lessonInterventionsResponseSchema = z.object({
  success: z.literal(true),
  data: z.array(lessonInterventionSchema),
});

export const uploadLessonMaterialResponseSchema = z.object({
  success: z.literal(true),
  data: z.object({
    batchId: z.string(),
    attempts: z.array(lessonMaterialUploadAttemptSchema),
  }),
});

export const lessonActivationStateResponseSchema = z.object({
  success: z.literal(true),
  data: activationStateSchema,
});

export const lessonReportsResponseSchema = z.object({
  success: z.literal(true),
  data: z.object({
    reports: z.array(
      z.object({
