...
export function TeacherTeachingHome(
  ...
  const activeSessionCount = countActiveSessions(lessons.map((lesson) => lesson.status));
  const draftSessionCount = lessons.filter((lesson) => lesson.status === "draft").length;
  const pausedSessionCount = lessons.filter((lesson) => lesson.status === "paused").length;
  const archivedSessionCount = lessons.filter((lesson) => lesson.status === "archived").length;
