...
import { expertInvitations } from "@/shared/db/schema";
import { defaultAppLocale, isAppLocale, type AppLocale } from "@/shared/i18n/config";
...
export async function createExpertInvitation(params: {
  ...
  return requireValue(invitation, "Failed to create expert invitation.");
}
