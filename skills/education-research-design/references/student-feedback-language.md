...
Use language that feels respectful, concrete, and low-pressure for students and learners.
...
- Avoid leading frames such as `What did you love` or `What went wrong` as the opening form.
- Offer neutral recall prompts first, then probe for meaning.
- Separate description from evaluation: first ask what happened, then why it mattered.
- Do not imply the respondent should be grateful, high-performing, or highly engaged.
...
- `Would you say the program was effective?`
- `How satisfied were you overall and why?`
