...
import {
  ...
  GPT_4_1_MINI_ID,
  google,
} from "@/shared/ai/language-models";
import "@/shared/ai/retrieval-adapters";
import {
  generateText,
  streamText,
  type ModelMessage,
...
import type { ContextBundle, PromptSpec } from "@/shared/ai/core";
import type { PromptExample } from "@/shared/ai/core/prompt-context-types";
import { resolvePromptExecution } from "@/shared/ai/core";
import {
...
function omitMessageId(message: UIMessage): Omit<UIMessage, "id"> {
...
export async function generateAIResponse(
  ...
  await logUsage(
    createUsageLogInput("llm_text", model, result.usage, options?.attribution),
  );
