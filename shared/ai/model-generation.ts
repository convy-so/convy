...
import { tutorAnalysisModel, tutorChatModel } from "@/shared/ai/models";
import { preparePromptCache, type PromptCacheOptions } from "@/shared/ai/prompt-caching";
import { resolvePromptExecution } from "@/shared/ai/core/prompt-execution";
import type { ContextBundle, PromptExample, PromptSpec } from "@/shared/ai/core/prompt-context-types";
import { logUsage, type UsageLogInput } from "@/shared/billing/logger";
...
export async function generateStructuredOutput<TSchema extends z.ZodTypeAny>(
  ...
  try {
    ...
    const parsedOutput: unknown = result.output;
    return parsedOutput as z.infer<TSchema>;
  } catch (err) {
